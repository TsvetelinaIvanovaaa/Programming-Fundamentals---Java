...
public class GuineaPig {
    public static void main(String[] args) {
        ...
        double heyQuantityKg = Double.parseDouble(scanner.nextLine());
        ...
        double heyQuantityGr = heyQuantityKg * 1000;
        ...
        for (int day = 1; day <= 30 ; day++) {
            ...
            if(day % 2 == 0){
                ...
                heyQuantityGr = heyQuantityGr - currentHey;
            }
            ...
            if(foodQuantityGr <= 0 || heyQuantityGr <= 0 || coverQuantityGr <= 0){
                isNotEnough = true;
                break;
            }
        }
        if(isNotEnough){
            ...
            System.out.printf("Everything is fine! Puppy is happy! Food: %.2f, Hay: %.2f, Cover: %.2f.",
                    foodQuantityGr/1000,heyQuantityGr/1000,coverQuantityGr/1000 );
        }
